...
<head>
  ...
  <title>Sunflower | Sửa nguyên vật liệu</title>
...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="nguyenVatLieu.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Xem nguyên vật liệu</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="nguyenVatLieu-Them.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Thêm nguyên vật liệu</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="nguyenVatLieu-Sua.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Sửa nguyên vật liệu</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                <li class="breadcrumb-item active">Sửa nguyên vật liệu</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" id="inputName" class="form-control" value="Tôm sú">
                </div>
                <div class="form-group">
                  <label for="inputQuantity">Số lượng</label>
                  <input type="number" id="inputQuantity" class="form-control" value="25">
                </div>
                <div class="form-group">
                  <label for="inputUnit">Đơn vị tính</label>
                  <select id="inputUnit" class="form-control custom-select">
                ...
                <div class="form-group">
                  ...
                  <input type="number" id="inputPrice" class="form-control" value="205000">
                </div>
                <div class="form-group">
                  <label for="inputTotal">Thành tiền</label>
                  <input type="text" id="inputTotal" class="form-control" value="5125000" disabled></input>
                  <script>
                    ...
                    function updateTotal() {
                      ...
                      if (!isNaN(quantity) && !isNaN(price)) {
                        ...
                        inputTotal.value = formatter.format(total);
                      }
                    }
                  </script>
                </div>
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2014-2021 <a href="https://Sunflower.io">Sunflower.io</a>.</strong> All rights reserved.
    </footer>
