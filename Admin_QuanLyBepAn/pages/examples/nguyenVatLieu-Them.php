...
<head>
  ...
  <title>Sunflower | Thêm nguyên vật liệu</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="nguyenVatLieu-Them.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Thêm nguyên vật liệu</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="nguyenVatLieu-Sua.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Thêm nguyên vật liệu</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                <li class="breadcrumb-item active">Thêm nguyên vật liệu</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
            ...
            <div class="card card-primary">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="inputTotal" class="form-control" disabled></input>
                  <script>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <input type="submit" value="Thêm nguyên liệu" class="btn btn-success float-right">
          </div>
        </div>
      </section>
      <!-- /.content -->
